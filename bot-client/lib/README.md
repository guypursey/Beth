...
*Object.* Contains objects, the key for each being a plain-string version of what should be searched for. Each of these objects contains the following properties :
...
Each object in the array can consist of the following properties:
